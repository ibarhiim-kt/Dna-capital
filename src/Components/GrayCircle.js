...
const GrayCircle = () => {    
    ...
    return(                      
        <svg height="350" width="380" class=" max-1280:h-[19.2vw] max-1280:w-[20.2vw]    max-1440:h-[267px] max-1440:w-[290px] max-1024:h-[195px] max-1024:w-[220px] 
        ...
        <circle r="180" cx="50%" cy="50%" stroke="url(#grayStroke)" stroke-width="4" fill="none" className='max-1440:hidden'/>   
