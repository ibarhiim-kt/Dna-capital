...
export default function HealthcareExperience() {
  ...
  return (
    ...
    <div className='max-w-[2000px] max-850:max-w-[88vw] max-500:max-w-none
      ...
      max-850:px-[6.792vw] max-850:pb-[6.648vw]'>
        ...
        <div style={{background:"linear-gradient(143deg, #423676, rgba(38, 177, 245, 0) 88%)", transform:"translate(0%,0px)",  willChange:"transform", transformOrigin:"right top"}} className='w-[100%] h-[100%] top-0 left-0 
